...
class FlexibleEnum(TypeDecorator):
    ...
    impl = SQLAString  # This tells SQLAlchemy to store the value as a string
    ...
    def process_result_value(self, value, dialect):
        ...
        try:
            ...
            # If the value doesn't match any enum, return the string value
            return value
...
class Content(Base):
    ...
    content_type = Column(FlexibleEnum(ContentType), nullable=False)  # 'text', 'voice' 
    category = Column(FlexibleEnum(Category), nullable=False, default=Category.OTHER)
    subject = Column(String(255), nullable=True)  # this is for email messages 
    ...
    source = Column(FlexibleEnum(Source), nullable=False)         # 'email', 'telegram'
